<template>
  <v-card-actions>
    <v-container class="ma-3">
      ...
      <v-row dense>
        <v-col cols="12" lg="2">
          <div class="text-caption pa-0">&darr; 特定時</div>
          <v-text-field
            class="pa-1"
            v-model="dataSearch.itemSetId"
            label="PCセット品目ID"
            clearable
          >
          </v-text-field>
        ...
        <v-col cols="12" lg="2">
          ...
          <v-combobox
            v-model="dataSearch.item_set_maker_model"
            label="PCセット資産タイプ"
            clearable
          />
        </v-col>
        ...
        <v-col cols="12" lg="2">
          <div class="text-caption pa-3"></div>
          <v-text-field
            v-model="dataSearch.item_set_jan_code"
            label="PCセット名称(前方一致)"
            clearable
          >
          </v-text-field>
      ...
      <v-row dense>
        ...
        <v-col cols="12" lg="2">
          <vc-input-date
            label="有効期間(From)"
            v-model="dataSearch.ItemSetexpirationDateFrom"
          ></vc-input-date>
        </v-col>
        <v-col cols="12" lg="2" class="pb-0">
          <vc-input-date
            label="有効期間(To)"
            v-model="dataSearch.itemSetExpirationDateTo"
          ></vc-input-date>
        </v-col>

        <v-spacer />
        <v-col cols="6" lg="1" align-self="center">
          <v-btn class="ma-3" color="blue lighten-3"> xoá クリア </v-btn>
        </v-col>
      </v-row>
      ...
      <v-expansion-panels class="mt-5">
        <v-expansion-panel>
          ...
          >
            tìm kiếm nâng cao 詳細検索条件
          </v-expansion-panel-title>
          <v-expansion-panel-text>
            <v-row class="mx-3" dense>
              <v-col cols="12" lg="2">
                <v-text-field label="メインPC品目ID" clearable> </v-text-field>
              </v-col>
              <v-col cols="12" lg="2">
                <v-combobox label="メインPCタイプ" clearable />
              </v-col>
              <v-col cols="12" lg="1">
                <v-text-field label="JANコード" clearable> </v-text-field>
              </v-col>
              <v-col cols="12" lg="1">
              ...
              <v-col cols="12" lg="2">
                <v-text-field label="メーカー型番" clearable> </v-text-field>
              </v-col>
              <v-col cols="12" lg="1">
                <v-select
                  fieldValue="value"
