...
class RentalOrderCartService {
   ...
   */
  async getAllRentalOrderCart(
    dataParam?: object
  ): Promise<RentalOrderCartCustomerResponse> {
  ...
  async getRentalOrderCartInfo(
    dataParam?: object
  ): Promise<RentalOrderCartModelResponse> {
    return await apiClient
  ...
  async deleteSoftRentalOrderCart(
    id: number
  ): Promise<RentalOrderCartCustomerResponse> {
    return await apiClient
  ...
  async deleteHardRentalOrderCart(
    id: number
  ): Promise<RentalOrderCartCustomerResponse> {
    return await apiClient
  ...
  async deleteSoftMultiRentalOrderCart(
    dataParam: object
  ): Promise<RentalOrderCartCustomerResponse> {
    return await apiClient
      .post(CONST.API.RENTAL_ORDER_CART.DELETE_SOFT_MULTI, {
        params: dataParam,
      })
      .then((response) => {
        return response.data as RentalOrderCartCustomerResponse;
